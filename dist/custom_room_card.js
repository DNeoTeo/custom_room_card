    ...
    `:F`<div>Loading editor…</div>`}_renderGeneralSection(){return F`
      <div class="editor-section">
        ...
        <div class="form-row">
          ...
          >
            ${Tt.map(t=>F`<mwc-list-item value=${t.value}>${t.label}</mwc-list-item>`)}
          </ha-select>
        </div>
    ...
    `}_renderNestedCardRow(t,e){const i=t.card?.type??"";return F`
      <div class="nested-card-row">
        ...
        <hui-card-element-editor
          ...
          .lovelace=${this._nestedCardsLovelace}
          .value=${t.card}
          @config-changed=${t=>this._updateNestedCardFromEditor(t,e)}
        ></hui-card-element-editor>
        ...
        <div class="preview-box"
          ...
          ${t.map((t,e)=>F`
              <div
                ...
                style=${gt({left:`${t.left??50}%`,top:`${t.top??50}%`})}
                draggable="true"
