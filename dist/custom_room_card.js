...
`;function Et(t,e){return e?.attributes?.icon?e.attributes.icon:function(t){const e=function(t){return t.split(".")[0]}(t);return wt[e]??"mdi:help-circle"}(t)}function kt(t,e,i){if(i)switch(i.action){case"toggle":t.callService("homeassistant","toggle",{},{entity_id:e});break;case"more-info":!function(t){const e=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}});document.querySelector("home-assistant")?.dispatchEvent(e)}(e);break;case"call-service":if(i.service){const[s,o]=i.service.split(".");t.callService(s,o,i.service_data??{},{entity_id:e})}break;case"navigate":i.navigation_path&&(window.history.pushState(null,"",i.navigation_path),window.dispatchEvent(new Event("location-changed")));break;case"url":i.url_path&&window.open(i.url_path,"_blank")}}function Tt(t){return JSON.parse(JSON.stringify(t))}window.customCards=window.customCards||[],window.customCards.push({type:$t,name:"Custom Room Card",description:"Adaptive room layout card with positioned entity buttons and nested Lovelace cards.",preview:!0,documentationURL:"https://github.com/your-user/custom-room-card"}),console.info("%c CUSTOM-ROOM-CARD %c v1.0.0 ","color: white; background: #2196f3; font-weight: bold; padding: 2px 6px; border-radius: 4px 0 0 4px;","color: #2196f3; background: #e3f2fd; font-weight: bold; padding: 2px 6px; border-radius: 0 4px 4px 0;");let zt=class extends at{constructor(){super(...arguments),this._nestedCards=new Map,this._cardScale=1,this._holdTriggered=!1}connectedCallback(){super.connectedCallback(),this._setupResizeObserver()}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect(),this._resizeObserver=void 0,this._observedContainer=void 0}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={show_title:!0,...t},this._nestedCards=new Map}getCardSize(){return 6}static getConfigElement(){return document.createElement("custom-room-card-editor")}static getStubConfig(){return{title:"My Room",entities:[]}}shouldUpdate(t){if(t.has("_config"))return!0;if(!t.has("hass"))return!0;const e=t.get("hass");if(!e)return!0;return(this._config?.entities??[]).some(t=>e.states[t.entity]!==this.hass.states[t.entity])}updated(t){if(super.updated(t),!this._observedContainer){const t=this.shadowRoot?.querySelector(".room-container");t&&this._resizeObserver&&(this._resizeObserver.observe(t),this._observedContainer=t)}t.has("_config")&&this._config?.nested_cards?.length&&this._createNestedCards(),t.has("hass")&&this._nestedCards.forEach(t=>{t.hass=this.hass})}render(){if(!this._config||!this.hass)return F`<ha-card>Loading…</ha-card>`;const t={"--card-scale":String(this._cardScale)},e=this._config.global_font_family||"system-ui";t["--title-font-family"]=e,t["--btn-label-font-family"]=e,t["--btn-state-font-family"]=e,this._config.title_style&&(this._config.title_style.font_size&&(t["--title-font-size"]=this._config.title_style.font_size*this._cardScale+"px"),this._config.title_style.text_color&&(t["--title-text-color"]=this._config.title_style.text_color)),this._config.button_label_style&&(this._config.button_label_style.font_size&&(t["--btn-label-font-size"]=`${this._config.button_label_style.font_size}px`),this._config.button_label_style.text_color&&(t["--btn-label-text-color"]=this._config.button_label_style.text_color)),this._config.button_state_style&&(this._config.button_state_style.font_size&&(t["--btn-state-font-size"]=`${this._config.button_state_style.font_size}px`),this._config.button_state_style.text_color&&(t["--btn-state-text-color"]=this._config.button_state_style.text_color));const i=this._config.card_styles??{};return F`
    ...
    `}_renderEntityButton(t){const e=function(t){return{...Ct,...t}}(t),i=this.hass.states[e.entity],s=function(t){if(!t)return!1;const e=t.state;return"off"!==e&&"unavailable"!==e&&"unknown"!==e&&"idle"!==e&&"closed"!==e&&"locked"!==e&&"disarmed"!==e}(i),o=!i||"unavailable"===i.state,r=e.icon??Et(e.entity,i),n=function(t,e){return t.label?t.label:e?.attributes?.friendly_name?e.attributes.friendly_name:t.entity}(e,i),a={"entity-btn":!0,active:s,unavailable:o},l=this._cardScale,d={left:`${e.left}%`,top:`${e.top}%`,width:(e.width??60)*l+"px",height:(e.height??60)*l+"px",transform:"translate(-50%, -50%)",...e.styles??{}};return e.font_size&&(d["--btn-label-font-size"]=`${e.font_size}px`,d["--btn-state-font-size"]=`${e.font_size}px`),F`
      ...
      >
        ...
        ${!1!==e.show_label?F`<span class="btn-label">${n}</span>`:V}
        ${e.show_state&&i?F`<span class="btn-state">${this.hass.formatEntityState(i)}</span>`:V}
      </button>
    ...
    `:F`<div>Loading editor…</div>`}_renderGeneralSection(){return F`
      <div class="editor-section">
        ...
        <div class="form-row">
          ...
          >
            ...
            ${Nt.map(t=>F`<mwc-list-item value=${t.value}>${t.label}</mwc-list-item>`)}
          </ha-select>
        </div>
    ...
    `}_renderTextStyleSection(){const t=this._config.title_style??{},e=this._config.button_label_style??{},i=this._config.button_state_style??{};return F`
      <div class="editor-section">
        <div class="section-title">
    ...
    `}_renderEntitiesSection(){const t=this._config.entities??[];return F`
      <div class="editor-section">
        <div class="section-title">
    ...
    `}_renderNestedCardsSection(){const t=this._config.nested_cards??[];return F`
      <div class="editor-section">
        <div class="section-title">
    ...
    `}_renderNestedCardRow(t,e){const i=t.card?.type??"";return F`
      <div class="nested-card-row">
        ...
        <hui-card-element-editor
          data-nested-card-index=${String(e)}
          .hass=${this.hass}
          .lovelace=${this._nestedCardsLovelace}
          .value=${t.card}
        ></hui-card-element-editor>
    ...
    `}_renderPreview(){const t=this._config.entities??[],e=this._config.nested_cards??[];return 0===t.length&&0===e.length?F`${V}`:F`
      <div class="editor-section">
        <div class="section-title">
